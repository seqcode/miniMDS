...
#rep 1
python ../minimds.py -l data/GM12878_combined_22_100kb.bed -p 0.01 -m 0.01 -o hic_data/GM12878_combined_22_10kb_minimds_rep1.tsv $BEDPATH

#rep 2
python ../minimds.py -l data/GM12878_combined_22_100kb.bed -p 0.01 -m 0.01 -o hic_data/GM12878_combined_22_10kb_minimds_rep2.tsv $BEDPATH
...
#create input
python hsa_input.py $BEDPATH hsa/GM12878_combined_22_10kb.tsv
...
#create input
python chromsde_input.py $BEDPATH ChromSDE/chr22_100kb_contacts.dat ChromSDE/chr22_10kb_ids.dat
