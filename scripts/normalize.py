...
def normalize_inter(hic_id, res, chrom_a, chrom_b, norm):
	...
	krpath1 = "{}/{}_resolution_interchromosomal/chr{}_chr{}/MAPQGE30/chr{}_{}.{}norm".format(hic_id, res_string, chrom1, chrom2, chrom1, res_string, norm)
	krpath2 = "{}/{}_resolution_interchromosomal/chr{}_chr{}/MAPQGE30/chr{}_{}.{}norm".format(hic_id, res_string, chrom1, chrom2, chrom2, res_string, norm)
...
def normalize_intra(hic_id, res, chrom, norm):
	res_string = tools.get_res_string(res)

	rawpath = "{}/{}_resolution_intrachromosomal/chr{}/MAPQGE30/chr{}_{}.RAWobserved".format(hic_id, res_string, chrom, chrom, res_string)
	krpath = "{}/{}_resolution_intrachromosomal/chr{}/MAPQGE30/chr{}_{}.{}norm".format(hic_id, res_string, chrom, chrom, res_string, norm)
	outpath = "{}_{}_{}_{}.bed".format(hic_id, chrom, res_string, norm)
...
def main():
	...
	parser.add_argument("norm", default="KR", help="normalization method [KR, VC, SQRTVC]")
	parser.add_argument("--chrom2", help="second chromosome (e.g. 2)")
	args = parser.parse_args()

	if args.chrom2 is None:
		normalize_intra(args.hic_id, args.res, args.chrom1, args.norm)
	else:
		normalize_inter(args.hic_id, args.res, args.chrom1, args.chrom2, args.norm)
